...
<body>
    ...
    <h1 class="cancer">Request an appointment</h1>
    <hr>
      ...
      <h4 class="login">  <p>Book Appointments.</p></h4>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
                <label>Recepients Legal name</label>
...
<div class="form-group">
                <label for="city">Have the recepient ever received any treatment of any NCDs at any hospital in the country?</label>
  ...
  <input type="text" list="towns" id="town" name="town">
    ...
    <option value="Aga Khan University Hospital"></option>
         ...
         <a href="appointments3.php">   <button class="btn-primary"> <input type="submit"  class="btn-primary" value="Submit"></button></a>
    </div>  
    </div>  
</body>